...
model.stage2_rpn.output_model_file = fullfile(fileparts(pwd),'output','rpn_cachedir',model.stage2_rpn.cache_name,imdbs_name,'final');
...
model.stage2_fast_rcnn.output_model_file = fullfile(fileparts(pwd),'output','fast_rcnn_cachedir',model.stage2_fast_rcnn.cache_name,imdbs_name,'final');
